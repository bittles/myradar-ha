"""Support for MyRadar (Dark Sky drop-in weather service."""
...
class DarkSkySensor(SensorEntity):
    """Implementation of a MyRadar sensor."""
    ...
    def update(self):
        ...
        # of time to prevent hitting API limits. Note that MyRadar will
