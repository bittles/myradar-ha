"""Support for retrieving meteorological data from MyRadar."""
...
class DarkSkyWeather(WeatherEntity):
    ...
    def __init__(self, name, dark_sky, mode):
        """Initialize MyRadar weather via the Dark Sky module."""
        self._name = name
...
class DarkSkyData:
    ...
    def update(self):
        ...
        try:
            ...
            #)
            forecastString = "https://api.myradar.dev/forecast/" +  self._api_key + "/" + str(self.latitude) + "," + str(self.longitude) + "?units=" + self.requested_units
            ...
            if not self._connect_error:
                ...
                _LOGGER.error("Unable to connect to MyRadar. %s", error)
            self.data = None
